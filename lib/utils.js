...
module.exports.rmd160 = function(input, encoding) {
  try {
    throw Error('rmd160 is deprecated, use ripemd160 instead.');
  } catch (e) {
    console.warn(e);
  }
  return this.ripemd160(input, encoding);
};

module.exports.ripemd160 = function(input, encoding) {
  return crypto.createHash('ripemd160').update(input, encoding).digest('hex');
}
...
module.exports.rmd160b = function(input, encoding) {
  try {
    throw Error('rmd160b is deprecated, use ripemd160b instead.');
  } catch (e) {
    console.warn(e);
  }
  return this.ripemd160b(input, encoding);
};

module.exports.ripemd160b = function(input, encoding) {
  return crypto.createHash('ripemd160').update(input, encoding).digest();
}
...
module.exports.rmd160sha256 = function(input, encoding) {
  try {
    throw Error('rmd160sha256 is deprecated, use ripemd160sha256 instead.');
  } catch (e) {
    console.warn(e);
  }
  return this.ripemd160sha256(input, encoding);
};

module.exports.ripemd160sha256 = function(input, encoding) {
  return module.exports.ripemd160(
    Buffer.from(module.exports.sha256(input, encoding), 'hex')
  );
};
...
module.exports.rmd160sha256b = function(input, encoding) {
  return module.exports.ripemd160b(module.exports.sha256b(input, encoding))
};
...
module.exports.sha1whirlpool = function(input, encoding) {
  return module.exports.sha1(
    Buffer.from(module.exports.whirlpool(input, encoding), 'hex')
  );
};
...
module.exports.generateToken = function() {
  return module.exports.ripemd160sha256(crypto.randomBytes(512));
};
...
module.exports.createEciesCipher = function(privateKey, publicKey) {
  ...
  cipher.publicKey(bitcore.PublicKey.fromDER(Buffer.from(publicKey, 'hex')));
...
module.exports.simpleEncrypt = function(password, str) {
  ...
  var b = aes256.final();
  var buf = Buffer.alloc(a.length + b.length);
...
module.exports.calculateBucketId = function(user, bucketName) {
  var ripemd160sha256 = module.exports.ripemd160sha256;
  var hash = ripemd160sha256(user + bucketName, 'utf-8');
...
module.exports.calculateFileId = function(bucket, fileName) {
  var ripemd160sha256 = module.exports.ripemd160sha256;
  var hash = ripemd160sha256(bucket + fileName, 'utf-8');
  return hash.substring(0, 24);
};
