...
Network.STORJ_BRIDGE_KEY = 'xpub6AHweYHAxk1EhJSBctQD1nLWPog6Sy2eTpKQL' +
  'ExR1hfzTyyZQWvU4EYNXv1NJN7GpLYXnDLt4PzN874g6zSjAQdFCHZN7U7nbYKYVDUzD42';

Network.DEFAULTS = {
  bridges: [
    {
      url: process.env.STORJ_BRIDGE || 'https://api.storj.io',
...
Network.prototype._verifyMessage = function(message, contact, callback) {
  ...
  this._validateContact(contact, function(err) {
    ...
    var addr = bitcore.Address.fromPublicKeyHash(Buffer.from(contact.nodeID, 'hex'));
